...
void Geometry::makeTriangle(unsigned int vert0, unsigned int vert1, unsigned int vert2)
{
	...
	normals[vert0 * 3 + 0] = 0.0f;
	normals[vert0 * 3 + 1] = 0.0f;
	normals[vert0 * 3 + 2] = 1.0f;
	normals[vert1 * 3 + 0] = 0.0f;
	normals[vert1 * 3 + 1] = 0.0f;
	normals[vert1 * 3 + 2] = 1.0f;
	normals[vert2 * 3 + 0] = 0.0f;
	normals[vert2 * 3 + 1] = 0.0f;
	normals[vert2 * 3 + 2] = 1.0f;
